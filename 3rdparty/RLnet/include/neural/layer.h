...
{
public:
    Layer(int id_layer, NeuralNetwork* net, unordered_map<string,int> parameters);
	...
	const unordered_map<string, int>& getParameters() const;
...
public:
	...
	unordered_map<string, int> _parameters;
};
