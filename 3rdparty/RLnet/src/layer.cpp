#include "../include/neural/layer.h"

Layer::Layer(int id_layer, NeuralNetwork* net, unordered_map<string, int> parameters)
{
    _id_layer = id_layer;
	_net = net;
...
const unordered_map<string, int>& Layer::getParameters() const
{
	return _parameters;
}
